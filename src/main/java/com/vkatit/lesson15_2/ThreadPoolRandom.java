...
public class ThreadPoolRandom {
    ...
    ThreadPoolRandom() {
        ...
        executor.execute(new MyThread(cdl1, "Thread_1"));
        executor.execute(new MyThread(cdl2, "Thread_2"));
        executor.execute(new MyThread(cdl3, "Thread_3"));
        executor.execute(new MyThread(cdl4, "Thread_4"));
